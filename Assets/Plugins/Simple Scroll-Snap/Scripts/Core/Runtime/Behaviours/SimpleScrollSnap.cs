...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public event Action<bool> EventBeginScrolling;
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            if (useHardSnapping)
            {
                ...
                EventBeginScrolling?.Invoke(true);
            }
        ...
        public void GoToPanel(int panelNumber)
        {
            ...
            if (useHardSnapping)
            {
                ...
                EventBeginScrolling?.Invoke(false);
            }
        }
        ...
        public T AddToFront<T>(T panel) where T : MonoBehaviour
        {
            return Add(panel, 0);
        }
        public T AddToBack<T>(T panel) where T : MonoBehaviour
        {
            return Add(panel, NumberOfPanels);
        }
        public T Add<T>(T panel, int index) where T : MonoBehaviour
        {
